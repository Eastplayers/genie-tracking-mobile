            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    if !appState.isInitialized {
                        ...
                        Text("✅ Tracker initialized - \(statusMessage)")
                            .font(.caption)
                            .foregroundColor(.secondary)
                            .padding()
                            .frame(maxWidth: .infinity)
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        .disabled(userId.isEmpty || !appState.isInitialized)
                    }
                    .padding()
                    .background(Color.blue.opacity(0.1))
                    .cornerRadius(12)
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        .buttonStyle(.borderedProminent)
                        .tint(.green)
                        .disabled(eventName.isEmpty || !appState.isInitialized)
                    }
                    .padding()
                    .background(Color.green.opacity(0.1))
                    .cornerRadius(12)
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        .buttonStyle(.borderedProminent)
                        .tint(.orange)
                        .disabled(screenName.isEmpty || !appState.isInitialized)
                    }
                    .padding()
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        .buttonStyle(.borderedProminent)
                        .tint(.indigo)
                        .disabled(metadataKey.isEmpty || metadataValue.isEmpty || !appState.isInitialized)
                    }
                    .padding()
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        .buttonStyle(.borderedProminent)
                        .tint(.cyan)
                        .disabled((profileName.isEmpty && profileEmail.isEmpty) || !appState.isInitialized)
                    }
                    .padding()
